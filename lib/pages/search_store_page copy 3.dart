...
Store _store1 = new Store(1,"Tesco",sumScore(3,2,2),HashMap<String,int>(),"Groceries");
Store _store2 = new Store(2,"Amazon",sumScore(3,3,3),HashMap<String,int>(),"Shopping");
Store _store3 = new Store(3,"Unknown",sumScore(1,1,0),HashMap<String,int>(),"Unknown");
